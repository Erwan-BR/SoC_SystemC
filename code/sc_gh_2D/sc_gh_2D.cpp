/////////////////////////////////////////////////////////////
// Filename : sc_gh_2D.cpp
// Author   : Erwan BROUDIN, Adrien MILLASSEAU
// Company  : ENSEA
// Comment  : Coder le traitement du gradient horizontal 2D de l'image
/////////////////////////////////////////////////////////////
#include "./sc_gh_2D.h"

/// @brief Traitement d'un pixel pour le gradient horizontal 2D.
void gh_2D::gh_2D_trait()
{
    int pix_tmp = 0;
