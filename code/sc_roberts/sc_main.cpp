...
int sc_main(int argc, char *argv[])
{
	...
	roberts roberts1("roberts");
	roberts1.reset(reset);
	roberts1.blank(blank);
	roberts1.clk(pckout);
	roberts1.pixel_in(pixel_in);
	roberts1.pixel_out(pixel_out);
	roberts1.hpix_out(hpix_out);
	roberts1.bk_out(bk_out);
	roberts1.sh(sh);
