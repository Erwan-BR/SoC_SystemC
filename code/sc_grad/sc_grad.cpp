/////////////////////////////////////////////////////////////
// Filename : sc_grad.cpp
// Author   : Erwan BROUDIN, Adrien MILLASSEAU
// Company  : ENSEA
// Comment  : Coder le traitement du gradient complet de l'image
/////////////////////////////////////////////////////////////
#include "./sc_grad.h"
#include <iostream>
#include <stdlib.h>

/// @brief Traitement d'un pixel pour le gradient.
void grad::grad_trait()
{
    int pix_tmp = 0;
